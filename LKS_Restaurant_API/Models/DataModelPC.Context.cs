...
namespace LKS_Restaurant_API.Models
{
    ...
    public partial class LKS_RestaurantPCEntities : DbContext
    {
        public LKS_RestaurantPCEntities()
            : base("name=LKS_RestaurantPCEntities")
        {
        }
        ...
        public virtual DbSet<menu_view> menu_view { get; set; }
        public virtual DbSet<pay_view> pay_view { get; set; }
        public virtual DbSet<payment_view> payment_view { get; set; }
